...
CronJob.prototype = {
  ...
  setCallback: function(callback) {
    //only functions
    if (typeof callback == 'function') this._callbackOnTick = callback;
  },

  /**
   * Fire registered callback.
   */
  _callbackExecute: function() {
    //send this so the callback can call this.stop();
    this._callbackOnTick.call(this.context, this.onComplete);
  },
